...
por decisiones humanas aprobadas. FND-003, FND-004, FND-005 y todas las demás Work Packages
permanecen `DRAFT`; ninguna Work Package está actualmente en `READY` ni autorizada para
implementación.
...
En el snapshot actual, FND-001 y FND-002 están finalizadas. FND-003, FND-004, FND-005 y todas las
demás WPs permanecen `DRAFT` y no están autorizadas; ninguna WP está en `READY`. Ninguna WP puede
pasar a `READY` sólo por despejar dependencias: todas requieren revisión humana de
...
limpio. FND-003, FND-004 y FND-005 no fueron implementadas ni autorizadas.
...
- FND-001 y FND-002 están `DONE`. FND-003, FND-004 y FND-005 permanecen `DRAFT`; ninguna WP está
  en `READY` y sólo podrán avanzar tras autorización humana explícita.
...
FND-002 están `DONE`; FND-003, FND-004, FND-005 y todas las demás WPs permanecen `DRAFT`. Ninguna
WP está en `READY` ni autorizada. El Walking Skeleton sólo se considera implementado y aprobado
localmente cuando:
